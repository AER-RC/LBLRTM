!     path:      $HeadURL: https://svn.aer.com/svn/aer/project/RD/LBLRTM/trunk/src/lblparams.inc $
!     author:    $Author: dweisens $
!     revision:  $Revision: 10658 $
!     created:   $Date: 2011-10-13 13:52:25 -0400 (Thu, 13 Oct 2011) $
!
!  --------------------------------------------------------------------------
