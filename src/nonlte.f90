!     path:      $HeadURL: https://svn.aer.com/svn/aer/project/RD/LBLRTM/trunk/src/nonlte.f90 $
!     author:    $Author: malvarad $
!     revision:  $Revision: 31066 $
!     created:   $Date: 2017-03-06 16:45:52 -0500 (Mon, 06 Mar 2017) $
!
!  --------------------------------------------------------------------------
...
!                                                                       
     ...
     &                CF3(102),CER(102)                                 
!                                                                       
      COMMON /FNSHQ/ IFN,F1(NFMX),F2(NFMX),F3(NFMX),FG(NFMX),XVER(NFMX) 
      COMMON /R4SUB/ VLOF4,VHIF4,ILOF4,IST,IHIF4,LIMIN4,LIMOUT,ILAST,   &
     &               DPTMN4,DPTFC4,ILIN4,ILIN4T                         
      COMMON /IFIL/ IRD,IPR,IPU,NOPR,NFHDRF,NPHDRF,NFHDRL,NPHDRL,       &
     &              NLNGTH,KFILE,KPANEL,LINFIL,NFILE,IAFIL,IEXFIL,      &
