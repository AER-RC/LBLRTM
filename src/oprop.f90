!     path:      $HeadURL: https://svn.aer.com/svn/aer/project/RD/LBLRTM/trunk/src/oprop.f90 $
!     revision:  $Revision: 31155 $
!     created:   $Date: 2017-03-21 08:33:04 -0400 (Tue, 21 Mar 2017) $  
!     presently: %H%  %T%
!
!  --------------------------------------------------------------------------
...
!                                                                       
   ...
   10    CALL BUFIN_sgl(Lnfl,LEOF,rdlnpnl,npnlhd) 
         !print *,'leof,vmax ',leof,rdlnpnl%vmax
         IF (LEOF.EQ.0) THEN 
         !print *,'leof eq 0',dumbuf%vnu(1:5)
...
!                                                                       
         ...
         !print *,'lnfl =',lnfl
         !print *,'vbot,vmax ',vbot,rdlnpnl%vmax
