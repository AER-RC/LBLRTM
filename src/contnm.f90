...
!     Self correction factors for 820-960 cm-1.                         
     ...
     &     1.01,1.002,1.00/                                             
!                                                                       
!     Self correction factors for 1880-3190 cm-1.
!     1880-2390 cm-1 - mt_ckd_2.8;  2400-3190 cm-1 - mt_ckd_2.5.
!      DATA (XFACREV1(I),I=1,132)/                                       &
...
!     &     1.064,1.024,0.971,0.939,0.944,                               &
!     &     0.949,0.966,0.979,0.988,0.993,                               &
!     &     1.000,1.029,1.063,1.101,1.145,                               &
!     &     1.194,1.248,1.307,1.372,1.443,                               &
!     &     1.520,1.599,1.687,1.777,1.875,                               &
!     &     1.975,2.077,2.183,2.291,2.401,                               &
!     &     2.509,2.621,2.725,2.840,2.940,                               &
!     &     3.051,3.143,3.249,3.351,3.467,                               &
!     &     3.577,3.702,3.816,3.946,4.057,                               &
!     &     4.198,4.325,4.458,4.588,4.718,                               &
!     &     4.852,4.976,5.096,5.214,5.322,                               &
!     &     5.410,5.477,5.555,5.585,5.605,                               &
!     &     5.630,5.645,5.640,5.630,5.600,                               &
!     &     5.575,5.580,5.625,5.510,5.482,                               &
!     &     5.505,5.467,5.423,5.372,5.283,                               &
!     &     5.218,5.090,4.936,4.773,4.577,                               &
!     &     4.365,4.130,3.888,3.635,3.404,                               &
!     &     3.156,2.923,2.722,2.537,2.338,                               &
!     &     2.181,2.044,1.913,1.807,1.692,                               &
!     &     1.619,1.574,1.490,1.470,1.386,                               &
!     &     1.348,1.321,1.284,1.255,1.237,                               &
...
!     &    1.000,0.999,                                                  &
!     &    0.998,0.996,0.993,0.988,0.979,                                &
!     &    0.966,0.949,0.926,0.900,0.872,                                &
!     &    0.844,0.821,0.805,0.800,0.805,                                &
!     &    0.821,0.844,0.872,0.900,0.926,                                &
!     &    0.949,0.966,0.979,0.988,0.993,                                &
!     &    0.996,0.998,0.999,1.000,1.000,                                &
!     &    1.000,1.059,1.128,1.208,1.300,                                &
!     &    1.406,1.524,1.659,1.807,1.976,                                &
!     &    2.160,2.360,2.581,2.822,3.082,                                &
!     &    3.358,3.662,3.975,4.333,4.693,                                &
!!    mt_ckd_2.5 coefficients start here.
...
!     Modified in mt_ckd_2.8 Feb 2016
!   *** 
!                                                                
...
!                                                                       
     ...
     &     '   mt_ckd_2.8 - modify 1880-2390 cm-1    (Mar 2016)',       &
     &     '            AIR           0 - 20000 CM-1           ',       &
...
!                                                                       
     ...
     &     '                                         (Feb 2016)',       &
     &     '  N2-H2O from 2000-3000 cm-1,H2O self for 1880-2400',       &
     &     ' cm-1,H2O foreign in windows >1880 cm-1  (Mar 2016)',       &
     &     '  -------------------------------------------------',       &
     &     '---------------------------------------------------',       & 
     &     '  -------------------------------------------------',       &
     &     '---------------------------------------------------'/       
