!     path:      $HeadURL: https://svn.aer.com/svn/aer/project/RD/LBLRTM/trunk/src/fftscn.f90 $
...
!*****Assign CVS name and version number to module fftscn.f             
                                                                        
      HNAMFFT=  '         fftscn.f:' 
      HVRFFT = '$Revision: 27087 $' 
