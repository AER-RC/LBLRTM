!     path:      $HeadURL: https://svn.aer.com/svn/aer/project/RD/LBLRTM/trunk/src/lblrtm.f90 $
!     author:    $Author: rpernak $
!     revision:  $Revision: 32310 $
!     created:   $Date: 2018-04-03 15:03:18 -0400 (Tue, 03 Apr 2018) $
!
!  --------------------------------------------------------------------------
