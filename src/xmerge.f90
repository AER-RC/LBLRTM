!     path:      $HeadURL: https://svn.aer.com/svn/aer/project/RD/LBLRTM/trunk/src/xmerge.f90 $
!     revision:  $Revision: 32131 $
!     created:   $Date: 2017-12-28 12:33:14 -0500 (Thu, 28 Dec 2017) $  
!     presently: %H%  %T%
!
!  --------------------------------------------------------------------------
